...
const data = [{
...

    {
        ...
        secondParagraph: `But there are those who would threaten our safety, those who would see our way of life dismantled and destroyed. These criminals live among us and endanger our society from the inside, living as our friends, our neighbors, even among our families. Many will now wear a tawdry representation of a seemingly innocuous mockingjay bird, but be wary! The future they promise is fiction, a dangerous distraction from our goal; a peaceful Panem. `,

        thirdParagraph: `To guard our citizens against these evildoers, Peacekeepers endure strenuous training regimens to turn their exercise into instinct. Cadets train in a series of rigorous militaristic methods, so they can be exceedingly familiar in both physical fighting and weapon handling. Imbued with the latest advances in military technology, Peacekeeper equipment is nothing less than the best Panem has to offer. From sleek armor to cutting-edge firearms and military vehicles, Peacekeepers are outfitted and equipped to eradicate any threat. Fret not, these valiant forces are ready to risk life and limb to keep Panem safe.`
    }
];
...
data.forEach(data => {
    ...
    makeArticles.appendChild(printArticle(data.title, data.date, data.firstParagraph, data.secondParagraph, data.thirdParagraph))
})

function printArticle(title, date, firstParagraph, secondParagraph, thirdParagraph) {
    ...
    artP1.classList.add('p');
    artP2.classList.add('p');
